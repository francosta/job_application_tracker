...
User.create(name: "Fran", email: "francisco@fcosta.pt", password: "password", education: "Doctorate", image: "https://drive.google.com/uc?&id=1AM-P8361aVt4cB0Pl9jJs7nHQCJAUZdv", industry: industries.sample)
User.create(name: "Endy", email: "endyranaudo@gmail.com", password: "password", education: "First Grade", industry: industries.sample)
